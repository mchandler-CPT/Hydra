...
; Factory presets (must match PresetManager: %AppData%\bdEnergy\The Hydra\Presets)
Source: "installer_dist\Presets\*"; DestDir: "{userappdata}\bdEnergy\The Hydra\Presets"; Flags: ignoreversion recursesubdirs createallsubdirs
